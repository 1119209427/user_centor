...
type UserServiceClient interface {
	...
	UserChangePassword(ctx context.Context, in *UserRequestChangePassword, opts ...grpc.CallOption) (*UserDetailResponse, error)
	UserSendEmail(ctx context.Context, in *SendEmailRequest, opts ...grpc.CallOption) (*SendEmailRespond, error)
}
...
func (c *userServiceClient) UserChangePassword(ctx context.Context, in *UserRequestChangePassword, opts ...grpc.CallOption) (*UserDetailResponse, error) {
	out := new(UserDetailResponse)
	err := c.cc.Invoke(ctx, "/pb.UserService/UserChangePassword", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userServiceClient) UserSendEmail(ctx context.Context, in *SendEmailRequest, opts ...grpc.CallOption) (*SendEmailRespond, error) {
	out := new(SendEmailRespond)
	err := c.cc.Invoke(ctx, "/pb.UserService/UserSendEmail", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserServiceServer interface {
	...
	UserChangePassword(context.Context, *UserRequestChangePassword) (*UserDetailResponse, error)
	UserSendEmail(context.Context, *SendEmailRequest) (*SendEmailRespond, error)
...
func (UnimplementedUserServiceServer) UserChangePassword(context.Context, *UserRequestChangePassword) (*UserDetailResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UserChangePassword not implemented")
}
func (UnimplementedUserServiceServer) UserSendEmail(context.Context, *SendEmailRequest) (*SendEmailRespond, error) {
...
func _UserService_UserChangePassword_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UserRequestChangePassword)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.UserService/UserChangePassword",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).UserChangePassword(ctx, req.(*UserRequestChangePassword))
	}
	return interceptor(ctx, in, info, handler)
}

func _UserService_UserSendEmail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SendEmailRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServiceServer).UserSendEmail(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.UserService/UserSendEmail",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).UserSendEmail(ctx, req.(*SendEmailRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _UserService_UserSendEmail_Handler,
		},
	},
